...
<img src="https://latex.codecogs.com/png.image?\dpi{100}&space;\bg_white&space;y(t)&space;=&space;x(t)&space;-&space;\alpha&space;x(t-1)" title="\bg_white y(t) = x(t) - \alpha x(t-1)" />
