...
<img src="https://latex.codecogs.com/svg.image?\bg_white&space;\inline&space;y(t)&space;=&space;x(t)&space;-&space;\alpha&space;x(t-1)" title="\bg_white \inline y(t) = x(t) - \alpha x(t-1)" />
